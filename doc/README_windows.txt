...
Intro
-----
p2p (P2P) is a sustainable cryptocurrency modeled after 
...
Setup
-----
Unpack the files into a directory and run p2p-qt.exe.

p2p Core is the original p2p client and it builds the backbone of the network.
However, it downloads and stores the entire history of p2p transactions;
