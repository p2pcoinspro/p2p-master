...
In order to support loading of multiple wallets in p2p-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is p2p.cpp.
...
Changes to p2p.cpp
----------------------
p2p.cpp is the entry point into p2p-qt, and as such, will require some minor modifications to provide hooks for
