...
RESOURCES += src/qt/p2p.qrc src/qt/p2p_locale.qrc

TRANSLATIONS += src/qt/locale/p2p_bg.ts \
                src/qt/locale/p2p_de.ts \
                src/qt/locale/p2p_en.ts \
                src/qt/locale/p2p_es.ts \
                src/qt/locale/p2p_fi.ts \
                src/qt/locale/p2p_fr.ts \
                src/qt/locale/p2p_it.ts \
                src/qt/locale/p2p_ja.ts \
                src/qt/locale/p2p_pl.ts \
                src/qt/locale/p2p_pt.ts \
                src/qt/locale/p2p_ru.ts \
                src/qt/locale/p2p_sk.ts \
                src/qt/locale/p2p_sv.ts \
                src/qt/locale/p2p_vi.ts \
                src/qt/locale/p2p_zh_CN.ts \
                src/qt/locale/p2p_zh_TW.ts
