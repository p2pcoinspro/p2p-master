...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("p2p Core p2p-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  p2p-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded p2p transaction") + "\n" +
                               "  p2p-tx [options] -create [commands]   " + _("Create hex-encoded p2p transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded p2p transaction
