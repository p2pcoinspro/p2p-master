...
#if defined(NDEBUG)
#error "p2p cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in up2p) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // P2P: We use certain sporks during IBD, so check to see if they are
...
int ActiveProtocol()
{
    ...
    // SPORK_14 was used for 70915. Nodes < 70915 don't see it and still get their protocol version
