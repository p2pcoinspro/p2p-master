...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* p2p features */
        {"p2p", "masternode", &masternode, true, true, false},
        {"p2p", "listmasternodes", &listmasternodes, true, true, false},
        {"p2p", "getmasternodecount", &getmasternodecount, true, true, false},
        {"p2p", "masternodeconnect", &masternodeconnect, true, true, false},
        {"p2p", "masternodecurrent", &masternodecurrent, true, true, false},
        {"p2p", "masternodedebug", &masternodedebug, true, true, false},
        {"p2p", "startmasternode", &startmasternode, true, true, false},
        {"p2p", "createmasternodekey", &createmasternodekey, true, true, false},
        {"p2p", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"p2p", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"p2p", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"p2p", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"p2p", "getmasternodescores", &getmasternodescores, true, true, false},
        {"p2p", "mnbudget", &mnbudget, true, true, false},
        {"p2p", "preparebudget", &preparebudget, true, true, false},
        {"p2p", "submitbudget", &submitbudget, true, true, false},
        {"p2p", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"p2p", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"p2p", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"p2p", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"p2p", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"p2p", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"p2p", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"p2p", "checkbudgets", &checkbudgets, true, true, false},
        {"p2p", "mnsync", &mnsync, true, true, false},
        {"p2p", "spork", &spork, true, true, false},
        {"p2p", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"p2p", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"p2p", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"p2p", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"p2p", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"p2p", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> p2p-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24514/\n";
}
