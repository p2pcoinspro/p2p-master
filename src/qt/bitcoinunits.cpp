...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(P2P);
    unitlist.append(mP2P);
    unitlist.append(uP2P);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case P2P:
            return QString("P2P");
        case mP2P:
            return QString("Milli-P2P (1 / 1" THIN_SP_UTF8 "000)");
        case uP2P:
            return QString("Micro-P2P (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case P2P:
            return QString("TestP2Ps");
        case mP2P:
            return QString("Milli-TestP2P (1 / 1" THIN_SP_UTF8 "000)");
        case uP2P:
            return QString("Micro-TestP2P (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
