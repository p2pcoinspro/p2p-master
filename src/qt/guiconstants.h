...
/* p2p GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "p2p"
#define QAPP_ORG_DOMAIN "p2pcoin.com"
#define QAPP_APP_NAME_DEFAULT "p2p-Qt"
#define QAPP_APP_NAME_TESTNET "p2p-Qt-testnet"
