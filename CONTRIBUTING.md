Contributing to p2p Core
==================================

The p2p Core project operates an open contributor model where anyone is
...
The following applies to code changes to the p2p Core project, and is not to be
confused with overall p2p Network Protocol consensus changes.

Whether a pull request is merged into p2p Core rests with the project merge
...
Patches that change p2p consensus rules are considerably more involved than
...
Where a patch set proposes to change the p2p consensus, it must have been
...
The project leader is the release manager for each p2p Core release.
